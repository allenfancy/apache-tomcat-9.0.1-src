 ...
 * 这是一个低级的、高效的服务器请求。
 *
 * Most fields are GC-free, expensive operations are delayed until the  user code
 * needs the information.
 * 大多数字段GC-free、昂贵的操作延迟,直到用户代码需要的信息。
 * 
 ...
 * for processing the request in the most efficient way. 
 * 
 * 
 * Users ( servlets ) can access the information using a facade, which provides the high-level view
 * of the request.
 * 用户可以访问该信息通过使用门面，提供一个高级别的请求
 *
