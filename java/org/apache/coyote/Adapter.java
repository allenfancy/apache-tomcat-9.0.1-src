...
public interface Adapter {
     ...
     * 回调所有服务方法并且通知所有的监听器
     * 
     * @param req The request object 请求对象
     * @param res The response object 响应对象
     *
     ...
     * 给定的请求/响应处理做好准备。
     * This method requires that the request object has been populated with the information available
     ...
     * 用于检测请求和响应都回收。
     * If they have not then log a warning and force a recycle. 
     * 如果他们没有那么日志警告和强制回收。
     * 
     * This method is called as a safety
